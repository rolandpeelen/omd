...
import * as Stdlib__Fun from "./fun.bs.js";
...
function print_stat(c) {
  ...
  const l1 = Curry._1(Stdlib__Printf.sprintf(/* Format */{
            _0: {
              TAG: /* Float */8,
              _0: [
                /* Float_flag_ */0,
  ...
  const l2 = Curry._1(Stdlib__Printf.sprintf(/* Format */{
            _0: {
              TAG: /* Int */4,
              _0: /* Int_d */0,
              _1: /* No_padding */0,
...
function create_alarm(f) {
  const arec_active = Stdlib__Atomic.make(true);
  const arec = {
    active: arec_active,
    f: f
  };
  Stdlib__Domain.at_exit(function (param) {
        Stdlib__Atomic.set(arec_active, false);
      });
  Caml_external_polyfill.resolve("caml_final_register")(call_alarm, arec);
  return arec_active;
}
